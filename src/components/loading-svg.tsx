export default function LoadingSvg({ width, height }: { width: string, height: string}) {
  ...
  return (
    <svg style={styles} className="fill-white" fill="current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle cx="4" cy="12" r="3"><animate begin="0;spinner_z0Or.end" attributeName="cx" calcMode="spline" dur="0.5s" keySplines=".36,.6,.31,1" values="4;12" fill="freeze"/>
